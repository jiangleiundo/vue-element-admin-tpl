<template>
  <div>
    ...
    <div class="btns">  
      ...
      <el-button type="primary" size="mini" @click="handleLeft('and')">且</el-button>
      <el-button type="primary" size="mini" @click="handleLeft('brace')">{...}</el-button>
      <el-button type="primary" size="mini" @click="handleLeft('brackets')">(...)</el-button>
      ...
      <el-button type="primary" size="mini" @click="handleTxt('@Res')">公式结果</el-button>
    </div>
  </div>
</template>
<script>
